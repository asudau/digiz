    ...
    <table class="default collapsable">
        ...
        <thead>
            <tr class="sortable">
                ...
                <? endif ?>
                <th></th>
                <th ><?=get_title_for_status('tutor', 2)?></th>
                <? if($is_dozent) : ?>
        ...
        <? $fullname = $tutor['fullname'];?>
            <tr>
                ...
                <td>
                    <a href="<?= URLHelper::getLink("dispatch.php/profile?username=".$tutor['username'])?>" <? if ($tutor['mkdate'] >= $last_visitdate) echo 'class="new-member"'; ?>>
