...
<style> 
    #start_page #start_kurse .list_item .info { 
        position: absolute; 
        display: inline-block; 
        ...
        padding: 6px 22px 10px 35px; 
    } 
    #start_page #start_kurse .list_item .infobild { 
        width: 30px; 
        height: 30px; 
        float: left; 
        margin: 24px 0px 10px 9px; 
    } 
    /* Tooltip text */ 
    .info .tooltiptext { 
        visibility: hidden; 
...
<div class="columns small-12 medium-6 large-4 portal-boxenouter">
		...
		<div class="columns small-12 medium-6 large-4 portal-boxenouter">
			...
			<div class="portal-boxeninner" style="background-image: url(<?=$plugin->getPluginURL().'/assets/images/people.jpg' ?>)" onclick="changeclass(this);">
				...
				<div class="portal-boxenoverlay">
					<h3 class="portal-boxenheadline"></h3>
					<p class="portal-boxendate"></p>
					<div class="portal-boxentext"><p></p></div>
					<a href="<?=$GLOBALS['ABSOLUTE_URI_STUDIP']?>dispatch.php/messages/overview" type="submit" class="btn btn-primary portal-boxenbutton">weiter <?=Icon::create('arr_1right', 'info_alt')?></a>
					<button class="portal-boxenclose" onclick="changeBack(this);"><img src="<?=$plugin->getPluginURL()?>/assets/images/close.png" alt="[X]"></button>
				</div>
    ...
    <div class="columns small-12 medium-6 large-4 portal-boxenouter">
			<div class="portal-boxeninner" style="background-image: url(<?=$plugin->getPluginURL().'/assets/images/qualitaet.jpg' ?>)" onclick="changeclass(this);">
				...
				<div class="portal-boxenoverlay">
					<h3 class="portal-boxenheadline">Informationenen und Materialien rund um QM</h3>
					<p class="portal-boxendate"></p>
					<div class="portal-boxentext"><p></p></div>
					<a href="<?=$GLOBALS['ABSOLUTE_URI_STUDIP']?>dispatch.php/messages/overview" type="submit" class="btn btn-primary portal-boxenbutton">weiter <?=Icon::create('arr_1right', 'info_alt')?></a>
					<button class="portal-boxenclose" onclick="changeBack(this);"><img src="<?=$plugin->getPluginURL()?>/assets/images/close.png" alt="[X]"></button>
